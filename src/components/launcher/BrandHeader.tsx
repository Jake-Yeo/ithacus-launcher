...
type BrandHeaderProps = { busy: boolean; onReload: () => void }

export function BrandHeader({ busy, onReload }: BrandHeaderProps) {
  return <header className="flex items-center justify-between gap-4 border-b border-border/80 pb-5 sm:pb-7">
    ...
    <div className="flex shrink-0 items-center gap-2"><Button variant="secondary" disabled={busy} onClick={onReload} aria-label="Reload launcher data">Reload</Button><OnlineStatus /></div>
  </header>
}
